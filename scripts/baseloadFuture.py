...
def printTimeseries(tracking, fractionContracted):
	...
	if tracking:
		print "Tracking"
		stateAveragesPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/baseload/tracking/average/"+str(fractionContracted)+"Contracted.csv"
		averagesPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/baseload/tracking/averagesAll/"+str(fractionContracted)+"Contracted.csv"
		yearlyPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/baseload/tracking/yearly/"+str(fractionContracted)+"Contracted.csv"

	else:
		print "Non-Tracking"
		stateAveragesPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/baseload/fixed/average/"+str(fractionContracted)+"Contracted.csv"
		averagesPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/baseload/fixed/averagesAll/"+str(fractionContracted)+"Contracted.csv"
		yearlyPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/baseload/fixed/yearly/"+str(fractionContracted)+"Contracted.csv"
	...
	for location in locations.getLocations():
		...
		for year in np.arange(startYear, endYear + 1):
			...
			for i in np.arange(data.shape[0]):
				...
				# print "Option: "+str(optionValue)+"    totalRevenue: "+str(totalYearlyRevenue)
