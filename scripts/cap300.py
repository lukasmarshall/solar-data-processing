...
def printTimeseries(tracking, fractionContracted):
	if tracking:
		print "Tracking"
		stateAveragesPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/cap300/tracking/average/"+str(fractionContracted)+"Contracted.csv"
		averagesPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/cap300/tracking/averagesAll/"+str(fractionContracted)+"Contracted.csv"
		yearlyPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/cap300/tracking/yearly/"+str(fractionContracted)+"Contracted.csv"

	else:
		print "Non-Tracking"
		stateAveragesPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/cap300/fixed/average/"+str(fractionContracted)+"Contracted.csv"
		averagesPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/cap300/fixed/averagesAll/"+str(fractionContracted)+"Contracted.csv"
		yearlyPath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/cap300/fixed/yearly/"+str(fractionContracted)+"Contracted.csv"
	...
	print "Beginning $300 Cap Simulation"
	...
	for location in locations.getLocations():
		...
		for year in np.arange(startYear, endYear + 1):
			...
			for i in np.arange(data.shape[0]):
				...
				timePeriodHrs = 0.5
				if price > 300:
					payout = ((price - 300) * timePeriodHrs) * fractionContracted
