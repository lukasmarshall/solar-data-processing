...
def printTimeseries(tracking):
	...
	for location in locations.getLocations():
		...
		if tracking:
			stateAveragePath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/solarMarketFactor/tracking/stateAverage.csv"
			path = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/solarMarketFactor/tracking/"+locationName+".csv"
		else:
			stateAveragePath = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/solarMarketFactor/fixed/stateAverage.csv"
			path = "/Users/lukemarshall/Documents/Workspace/Thesis/simulationResults/market/solarMarketFactor/fixed/"+locationName+".csv"
